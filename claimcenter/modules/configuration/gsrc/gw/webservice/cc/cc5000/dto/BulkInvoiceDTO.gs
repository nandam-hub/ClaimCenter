 ...
 * A(n) {@link gw.webservice.cc.cc5000.dto.BulkInvoiceDTO} is a DTO that represents an instance of {@link BulkInvoice} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link BulkInvoice}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc5000.dto.BulkInvoiceDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc5000/dto/BulkInvoiceDTO")
