 ...
 */
@Export
@WsiExportable(("http://guidewire.com/cc/ws/gw/webservice/cc/cc5000/vendormanagement/DocumentWithContent"))
final class DocumentWithContent {

  /**
   * Metadata about the document.
   */
  var _documentSummary : gw.webservice.cc.cc5000.vendormanagement.DocumentSummary as DocumentSummary

  /**
   * The content of the document.
   */
  var _documentContent : gw.webservice.cc.cc5000.vendormanagement.DocumentContent as DocumentContent
