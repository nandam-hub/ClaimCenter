...
class ServiceRequestStatementPopulator {
  public static function populate(statement: ServiceRequestStatement, creationInstructions: gw.webservice.cc.cc5000.vendormanagement.StatementCreationInstructions) {
  ...
  public static function populateInvoice(invoice: ServiceRequestInvoice, creationInstructions: gw.webservice.cc.cc5000.vendormanagement.StatementCreationInstructions) {
    invoice.finishSetup(true)
  }

  private static function populateQuote(quote: ServiceRequestQuote, creationInstructions: gw.webservice.cc.cc5000.vendormanagement.StatementCreationInstructions) {
