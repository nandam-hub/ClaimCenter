...
class ClaimContactSearchRequest extends AbstractSearchRequest<FreeTextClaimSearchEntity> {
  ...
  override function bulkProcessResponseFields(results : List<FreeTextClaimSearchEntity>, startRank : int, store : SolrSearchStore) {
    ClaimContactSearchRequestHelper.bulkProcessResponseFields(results, startRank, store)
  }
