                ...
                .addRuleConditionLine(new RuleConditionLineBuilder()
                    ...
                    .withRightOperand(new ContainsExpressionFragmentBuilder()
                        ...
                        .withRuleCondition(new RuleConditionBuilder()
                            ...
                            .addRuleConditionLine("activity.Exposure.VehicleIncident", RuleOperator.TC_EQUALS, "exposure.VehicleIncident")
                            .addRuleConditionLine("activity.ActivityPattern.Code", RuleOperator.TC_EQUALS, "\"salvage_vehicle\"")))))
