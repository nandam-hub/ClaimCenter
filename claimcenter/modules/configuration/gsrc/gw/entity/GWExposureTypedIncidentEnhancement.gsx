...
enhancement GWExposureTypedIncidentEnhancement : entity.Exposure {
  ...
  property get APDIncident() : APDIncident { return this.Incident typeis APDIncident ? this.Incident : null }
  property set APDIncident(incident : APDIncident) { this.Incident = incident }
