...
class CCExtensionInterfacesMapper implements ExtensionInterfacesMapper {
  ...
  override function bindImplementations(config: ExtensionInterfacesConfig) {
    ...
    /**
     * AB 5040 integration extensions
     */

    config.setImplementation<IContactIntegrationMapperFactoryExtensions_AB5040>(\-> gw.contactmapper.ab5040.ContactIntegrationMapperFactory.mapper())

    config.setImplementation<ICCNameMapperExtensions_AB5040>(\-> gw.contactmapper.ab5040.CCNameMapper.Instance)
    ...
    config.setImplementation<ExtensionBinder<ServiceRequest>>(\ serviceRequest -> new IServiceRequestExtensions() {
      override property get AlreadyPromoted(): boolean {
        return serviceRequest.CoreSR.AlreadyPromoted
      }
