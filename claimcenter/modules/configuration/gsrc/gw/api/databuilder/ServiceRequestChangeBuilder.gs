...
class ServiceRequestChangeBuilder extends CCDataBuilder<ServiceRequestChange, ServiceRequestChangeBuilder>{
  ...
  construct() {
    ...
    set(ServiceRequestChange#ExpectedQuoteCompletionDateGw_Chg, false)
    set(ServiceRequestChange#ExpectedServiceCompletionDateGw_Chg, false)
  ...
  static function recordProgressAndQuoteStatusChange(newProgress: ServiceRequestProgress = null, newQuoteStatus: ServiceRequestQuoteStatus = null): ServiceRequestChangeBuilder {
    return new ServiceRequestChangeBuilder()
            ...
            .withExpectedServiceCompletionDateGwChange(false)
            .withExpectedQuoteCompletionDateGwChange(false)
   ...
   * @return the modified builder
   */
  function withExpectedServiceCompletionDateGwChange(expectedCompletionDateChg : boolean) : ServiceRequestChangeBuilder {
    set(ServiceRequestChange#ExpectedServiceCompletionDateGw_Chg, expectedCompletionDateChg)
    return this
  }  
   ...
   * @return the modified builder
   */
  function withNewExpectedServiceCompletionDateGw(newExpectedCompletionDate : Date) : ServiceRequestChangeBuilder {
    set(ServiceRequestChange#New_ExpectedServiceCompletionDateGw, newExpectedCompletionDate)
    return this
  } 
   ...
   * @return the modified builder
   */
  function withExpectedQuoteCompletionDateGwChange(expectedCompletionDateChg : boolean) : ServiceRequestChangeBuilder {
    set(ServiceRequestChange#ExpectedQuoteCompletionDateGw_Chg, expectedCompletionDateChg)
    return this
  }  
   ...
   * @return the modified builder
   */
  function withNewExpectedQuoteCompletionDateGw(newExpectedCompletionDate : Date) : ServiceRequestChangeBuilder {
    set(ServiceRequestChange#New_ExpectedQuoteCompletionDateGw, newExpectedCompletionDate)
    return this
  } 
  ...
  function withNewInstruction(newInstruction : ServiceRequestInstruction) : ServiceRequestChangeBuilder {
    return withNewInstruction(wrapBean<ServiceRequestInstruction>(newInstruction))
  } 
  ...
  function withInitiator(initiator : Contact) : ServiceRequestChangeBuilder {
    return withInitiator(wrapBean<Contact>(initiator))
  }
