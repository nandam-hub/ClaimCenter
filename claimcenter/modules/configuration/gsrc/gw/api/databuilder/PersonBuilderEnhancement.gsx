...
enhancement PersonBuilderEnhancement : PersonBuilder {
  ...
  /**
   * Sets the person's preferred email for claim updates to the supplied value
   * @param preferredEmailType the value to set for the person's preferred email for claim updates
   * @return the modified builder
   */
  function withClaimUpdatesViaEmailOptIn(preferredEmailType : PreferredEmailType) : PersonBuilder {
    this.set(Person#ClaimUpdatesViaEmailOptIn, preferredEmailType)
    return this
  }

  /**
   * Sets the person's preferred phone number for claim updates by text to the supplied value
   * @param preferredPhoneNumberType the value to set for the person's preferred phone number for claim updates by text
   * @return the modified builder
   */
  function withClaimUpdatesViaTextOptIn(preferredPhoneNumberType : PreferredPhoneNumberType) : PersonBuilder {
    this.set(Person#ClaimUpdatesViaTextOptIn, preferredPhoneNumberType)
    return this
  }
}
