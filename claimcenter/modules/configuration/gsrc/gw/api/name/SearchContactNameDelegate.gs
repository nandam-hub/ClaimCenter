...
class SearchContactNameDelegate implements PersonNameFields {
  ...
  override property get Name() : String {
    return _nameCriteria.CompanyName  // note: CCNameCriteria.Name used for Solr (see property #NameSolr below)
  }
  ...
  // for Solr - generic name used for company names and (full) person names
  property get NameSolr() : String {
    return _nameCriteria.Name
  }

  property set NameSolr(value: String) {
    _nameCriteria.Name = value
  }
