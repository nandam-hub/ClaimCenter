...
uses gw.plugin.pcintegration.pc5000.PolicySearchConverter
...
class PCPolicyRefreshConfiguration extends PolicyRefreshConfigurationBase {
  ...
  construct() {
    var schema = wsi.remote.gw.webservice.pc.pc5000.entities.util.SchemaAccess.Blueprint
  ...
  private property get NamespacePrefix() : String {
    var nsElems = wsi.remote.gw.webservice.pc.pc5000.entities.util.Type.Namespace.split("[.]")
