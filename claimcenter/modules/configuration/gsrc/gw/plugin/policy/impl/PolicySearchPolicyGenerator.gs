...
uses gw.api.databuilder.SequentialStringGenerator
...
class PolicySearchPolicyGenerator {
  ...
  private static var POLICY_SYSTEM_VEHICLE_ID_GENERATOR = SequentialStringGenerator.withPrefix("pc:", 1)
          ...
          policies.add(new gw.api.databuilder.PolicyBuilder()
              ...
              .withRiskUnit(new gw.api.databuilder.VehicleRUBuilder()
                  ...
                  .withVehicle(new gw.api.databuilder.VehicleBuilder()
                      ...
                      .withPolicySystemId(nextPolicySystemVehicleId()))
...
//        .create(bundle)
  ...
  private function nextPolicySystemVehicleId(): String {
    return POLICY_SYSTEM_VEHICLE_ID_GENERATOR.create(null)
  }
