...
class PCObjectConverterFactory {
  ...
  construct() {
    try {
      var pcToCcFile = Resources.PCTOCC_DATAMAPPING_PC5000
      _pcToCCTranslator = new gw.plugin.pcintegration.pc5000.PolicyNameTranslatorImpl( pcToCcFile, "wsi.remote.gw.webservice.pc.pc5000.entities.types.complex", "entity" )
    } catch( e : Throwable ) {
