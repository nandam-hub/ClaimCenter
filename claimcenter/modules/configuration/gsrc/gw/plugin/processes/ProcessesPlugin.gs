...
uses gw.surepath.cc.configuration.adminaudit.batch.DataAuditPurgeBatch
uses gw.surepath.cc.configuration.catastrophe.batch.ProactiveCatastropheClaimFinderBatch
...
uses parametric.batch.ParametricInsuranceBatch
  ...
  override function createBatchProcess(type : BatchProcessType, arguments : Object[]) : BatchProcess {
    switch(type) {
      ...
      case BatchProcessType.TC_CATASTROPHECLAIMFINDER:
          return new ProactiveCatastropheClaimFinderBatch()
      ...
      case BatchProcessType.TC_SOLRDATAIMPORT:
	    ...
	    case BatchProcessType.TC_PURGEDATAAUDITRECORDS_SP:
        return new DataAuditPurgeBatch()
      case BatchProcessType.TC_PARAMETRICINSURANCE:
        return new ParametricInsuranceBatch()
      default:
        return null
    }
  }
