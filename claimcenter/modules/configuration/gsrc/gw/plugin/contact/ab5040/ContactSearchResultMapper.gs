 ...
 */
  public static function populateContactFromDuplicateResult(contact:Contact, duplicateResult:ABContactAPIFindDuplicatesResultContainer_Results_Entry) {
    ...
    if (contact typeis Person) {
      ...
      contact.ClaimUpdatesViaEmailOptIn = PreferredEmailType.get(duplicateResult.ClaimUpdatesViaEmailOptIn)
      contact.ClaimUpdatesViaTextOptIn = PreferredPhoneNumberType.get(duplicateResult.ClaimUpdatesViaTextOptIn)
